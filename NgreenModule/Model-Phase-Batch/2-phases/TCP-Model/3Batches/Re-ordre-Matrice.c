...
void afficherEtats(int *t1,int *t2,int *t3,int *t4,int n)
{
	printf("[\n");
		for(int i=0;i<n;i++)
		printf("%d  %d  %d %d \n",t1[i],t2[i],t3[i],t4[i]);
...
void TrierEtats(int *t1,int *t2,int *t3,int *t4,int n) //5 éme tri lecxicographique: (X1,Y1)<(X2,Y2) si X1<X2 ou que X1=X2 et Y1>Y2
{
...
void OrdonnerMatrice(FILE *frii,int *I,char s[100],char rii[100],int n)
{
FILE *friiout;
char  riiout[100];
int i,j,c;
...
void Decoupage_NCD(int t1[40000],int t2[40000],int t3[40000],char s[100],long double seuil, int deadline,int n)
{
