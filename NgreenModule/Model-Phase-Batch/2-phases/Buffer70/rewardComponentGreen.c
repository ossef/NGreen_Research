...
{ 
    ...
    Marg_Cond_X_H(et,pi,ReachableStates,seuil,Deadline,s5,s6); 
	//Convolution_H_G(et,pi,ReachableStates,seuil,Deadline,s5,s6,s7); 
	//Pi_troncer(pi,ReachableStates,s8);
