...
barplot(pi1,names.arg = x, ylim=c(0,0.45), xlab = "x : Number of SDUs in PDU",ylab = "PrX(x)",col = "blue",border = "black")
abline(v=42, col="Red",lwd="4",lty=1)
...
barplot(pi2,names.arg = h, ylim = c(0,0.35), xlab = "t",ylab = "PrH(t)",col = "blue", border = "black")
abline(v=54, col="Red",lwd="4",lty=1)
...
barplot(piConv,names.arg = h, ylim = c(0,0.35), xlab = "t",ylab = "PrH_G(t)",col = "blue", border = "black")
