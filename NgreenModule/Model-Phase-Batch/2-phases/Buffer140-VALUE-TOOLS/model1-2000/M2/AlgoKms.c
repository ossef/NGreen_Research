...
{ 
	...
	long double s,prb;
	FILE *fsz,*fcii,*fcd,*fpi0,*fpart,*ftime;
	char s1[50], s2[50],s3[50], s4[50], s5[50]; 
	
	struct timeval tv1,tv2;
    long long temps;

/*---------Calcul du temps d"execution du processus une fois affectée au processeur------------*/ 
...
/*-----------Fin de l'execution du programme---------------------*/
 ...
 ftime = fopen("KMS_BASIC.time","a");
 fprintf(ftime,"%lld\n",temps);
 fclose(ftime);
 
 printf("\n ALGO KMS BASIC DONE, temps = %lld secondes\n \n",temps);
