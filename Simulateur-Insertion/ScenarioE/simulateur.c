...
#define STATIONS 20 //nombre de stations
#define DEADLINE 88 //Deadline tronquée liée à la distribution de H conv G  (voir modèle Buffer25)
#define BUFFER 1500 // taille du conteneur de PDUs (taille echeancier)
...
int MaxTrain = -1; //tailleMax d'un train dans l'anneau
...
void Generer_Fonct_Repart()
{
    ...
    FILE *f1 = fopen("Ngreen-Module-25-reordre.Conv.H.G.pi","r");
...
while(i<TAILLEMAX)
 ...
 if(TrainD[0] == 0 && TrainF[var1-1] == TAILLEMAX-1)
 {
