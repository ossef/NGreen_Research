...
plot(V1,V2,type="o",las=1,lab=c(10, 6, 1),xlim=c(12,16),ylim=c(0,150), pch=16,col="black",xlab="Number of stations",ylab="")
...
plot(V1,V2,type="o",las=1,lab=c(10, 6, 1),xlim=c(12,16),ylim=c(0,150), pch=15,col="red",xlab="",ylab="")
