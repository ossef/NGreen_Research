...
modelname1 = "test-ngreen-mod1-250.cd"
modelname2 = "test-ngreen-mod1-250.pi.Trunc"
modelname3 = "test-ngreen-mod1-250.MargCd.X.pi"
modelname4 = "test-ngreen-mod1-250.MargCd.H.pi"
modelname5 = "test-ngreen-mod1-250.Conv.H.G.pi"
...
abline(v=227.5, col="Red",lwd="2",lty=1)
...
barplot(pi2,names.arg = h,xlim = c(0,140), ylim=c(0,0.45), xlab = "t",ylab = "PrH(t)",col = "blue", border = "black")
abline(v=120, col="Red",lwd="1",lty=1)
...
barplot(piConv,names.arg = h,xlim = c(0,140), ylim=c(0,0.45),xlab = "t",ylab = "PrH_G(t)",col = "blue", border = "black")
