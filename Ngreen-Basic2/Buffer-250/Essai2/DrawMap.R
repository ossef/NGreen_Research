...
barplot(pi2,names.arg = h,xlim = c(0,90), ylim=c(0,0.47), xlab = "t",ylab = "PrH(t)",col = "blue", border = "black")
abline(v=72, col="Red",lwd="2",lty=1)
...
barplot(piConv,names.arg = h,xlim = c(0,90), ylim=c(0,0.45),xlab = "t",ylab = "PrH_G(t)",col = "blue", border = "black")
