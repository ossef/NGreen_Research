...
modelname1 = "test-ngreen-mod3-100-DAG.cd"
modelname2 = "test-ngreen-mod3-100-DAG.pi.Trunc"
modelname3 = "test-ngreen-mod3-100-DAG.MargCd.X.pi"
modelname4 = "test-ngreen-mod3-100-DAG.MargCd.H.pi"
...
abline(v=84, col="Red",lwd="3",lty=1)
