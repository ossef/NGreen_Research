...
modelname1 = "test-ngreen-mod1-666-DAG.cd"
modelname2 = "test-ngreen-mod1-666-DAG.pi.Trunc"
modelname3 = "test-ngreen-mod1-666-DAG.MargCd.X.pi"
modelname4 = "test-ngreen-mod1-666-DAG.MargCd.H.pi"
...
barplot(pi1,names.arg = x,xlab = "X",ylab = "P(X/Sortie)",col = "blue", main = "Courbe de la marginale conditionnel sur les paquets qui sortent",border = "blue")
abline(v=111.2, col="Red",lwd="2",lty=1)
...
barplot(pi2,names.arg = h,xlab = "H",ylab = "P(H/Sortie)",col = "blue", main = "Marginale sortie de H", border = "blue")
