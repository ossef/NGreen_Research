...
modelname1 = "test-ngreen-mod2-666.cd"
modelname2 = "test-ngreen-mod2-666.pi.Trunc"
modelname3 = "test-ngreen-mod2-666.MargCd.X.pi"
modelname4 = "test-ngreen-mod2-666.MargCd.H.pi"
modelname5 = "test-ngreen-mod2-666.Conv.H.G.pi"
...
abline(v=55.3, col="Red",lwd="2",lty=1)
