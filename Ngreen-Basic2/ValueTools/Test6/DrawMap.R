...
barplot(pi2,names.arg = h, ylim=c(0,0.12), xlab = "t",ylab = "PrH(t)",col = "blue", border = "black")
...
barplot(piConv,names.arg = h, ylim=c(0,0.12), xlab = "t",ylab = "PrH_G(t)",col = "blue", border = "black")
