...
modelname1 = "test-ngreen-25-DAG.cd"
modelname2 = "test-ngreen-25-DAG.pi"
modelname3 = "test-ngreen-25-DAG.MargCd.X.pi"
modelname4 = "test-ngreen-25-DAG.MargCd.H.pi"
modelname5 = "test-ngreen-25-DAG.Conv.H.G.pi"
...
levelplot(
  Pi ~ X*H, 
  xlab = "X", ylab = "H",
  sub="Parametres: J=8, A(n)={0,1,2,3}, J*0.75 = 6 and C = 8",
  colorkey = TRUE,
...
abline(v=25.4, col="Red",lwd="4",lty=1)
...
barplot(pi2,names.arg = h,xlim=c(0,50),ylim=c(0,0.24),xlab = "t",ylab = "PrH(t)",col = "blue", border = "black")
abline(v=36.1, col="Red",lwd="4",lty=1)
...
barplot(piConv,names.arg = h,xlim=c(0,50),ylim=c(0,0.24), xlab = "t",ylab = "PrH_G(t)",col = "blue", border = "black")
